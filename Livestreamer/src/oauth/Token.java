...
public class Token implements Serializable
{
  ...
  {
    if(token == null || token.isEmpty()) throw new IllegalArgumentException("Secret can't be null or empty.");
    if(secret == null || secret.isEmpty()) throw new IllegalArgumentException("Secret can't be null or empty.");
